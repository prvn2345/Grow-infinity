...
export default function Register() {
  ...
  const renderParentSubGroupOptions = () => {
    if (group === "grp-3") {
      return (
        <select value={subGroup} onChange={(e) => setSubGroup(e.target.value)} className="w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-sm" required>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4 md:p-6 font-sans">
      <div className="max-w-4xl w-full">
        
        {/* Header */}
        <div className="text-center mb-6 md:mb-10 flex flex-col items-center justify-center">
          <Link href="/" className="inline-flex items-center space-x-2 text-3xl md:text-4xl font-black bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent tracking-tight">
            <svg className="w-8 h-8 md:w-10 md:h-10 text-blue-600 animate-pulse" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          <p className="mt-2 text-slate-500 font-medium text-xs md:text-sm">Join our community of elite educators and ambitious students.</p>
        </div>

        {/* STEP 1: ROLE SELECTION */}
        {step === 1 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto">
            <h2 className="text-xl md:text-2xl font-bold text-center text-slate-800 mb-6 md:mb-8">How would you like to join us?</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div 
                ...
                className="group cursor-pointer bg-white rounded-3xl p-4 md:p-8 border-2 border-transparent hover:border-blue-500 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center shadow-lg"
              >
                <div className="w-14 h-14 md:w-24 md:h-24 bg-blue-50 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-2xl md:text-4xl">👨‍👩‍👦</span>
                </div>
                <h3 className="text-sm md:text-2xl font-black text-slate-800 mb-1.5 md:mb-3">I am a Parent</h3>
                <p className="hidden md:block text-slate-500 font-medium text-sm leading-relaxed">I am looking for a qualified home tutor for my child's bright future.</p>
                <div className="hidden md:flex mt-8 text-blue-600 font-bold opacity-0 group-hover:opacity-100 transition-opacity items-center text-sm">
              ...
              <div 
                ...
                className="group cursor-pointer bg-white rounded-3xl p-4 md:p-8 border-2 border-transparent hover:border-indigo-500 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center shadow-lg"
              >
                <div className="w-14 h-14 md:w-24 md:h-24 bg-indigo-50 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-2xl md:text-4xl">👨‍🏫</span>
                </div>
                <h3 className="text-sm md:text-2xl font-black text-slate-800 mb-1.5 md:mb-3">I am a Teacher</h3>
                <p className="hidden md:block text-slate-500 font-medium text-sm leading-relaxed">I want to teach students, manage classes, and grow my career.</p>
                <div className="hidden md:flex mt-8 text-indigo-600 font-bold opacity-0 group-hover:opacity-100 transition-opacity items-center text-sm">
                  Continue <span className="ml-2">→</span>
                </div>
              </div>
            ...
            <div className="mt-8 text-center">
              <Link href="/login" className="text-slate-500 hover:text-blue-600 font-medium transition-colors text-sm">
        ...
        {step === 2 && (
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 md:p-12 animate-in fade-in slide-in-from-right-8 duration-500 relative max-w-2xl mx-auto">
            ...
            <button 
              ...
              className="absolute top-6 left-6 text-slate-400 hover:text-slate-600 font-semibold flex items-center transition-colors text-xs md:text-sm cursor-pointer"
            >
              ← Back
            </button>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              {error && (
                <div className="bg-red-50 text-red-650 p-4 rounded-xl border border-red-100 flex items-center text-xs font-semibold animate-in shake duration-300">
